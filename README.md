...
A fast, installable invoicing PWA based on the supplied Eng Hoon Residences invoice. It runs as a normal web app, saves drafts locally, works offline after the first visit, downloads named A4 PDF files, and can also print through the browser's print dialog.
...
4. Choose **Save as PDF** to download the named file, or **Print** to open the browser print dialog.
